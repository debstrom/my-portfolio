...
const resume = () => {
  return (
      <div className='border w-48 h-12 border-[#00000095] hover:border-[#9956C4] relative left-0 rounded-full visible group hover:text-white ease-in-out overflow-hidden md:top-0 top-6'>
        <a className=''  href="">
